    ...
    var Rt = {
                          ...
                          (t
                              ...
                              : c &&
                                ((t = h.width) < (i = h.height) * s
                                    ? (t = i * s)
                                    : (i = t / s))),
                    (t = (s = Lt({ aspectRatio: s, width: t, height: i }))
                        .width),
                    (i = s.height),
                    (o.minWidth = t),
                    (o.minHeight = i),
                        ...
                        ((c ? 0 : 1) < r
                            ? ((i = n.width - o.width),
                              ...
                              c &&
                                  ...
                                  ((o.minLeft = Math.min(
                                      h.left,
                                      h.left + (h.width - o.width)
                                  )),
                                  (o.minTop = Math.min(
                                      h.top,
                                      h.top + (h.height - o.height)
                                  )),
                                  (o.maxLeft = h.left),
                                  (o.maxTop = h.top),
                                  2 === r &&
            ...
            initCropBox: function () {
                ...
                i &&
                    ...
                    (t.width = Math.min(
                        Math.max(t.width, t.minWidth),
                        t.maxWidth
                    )),
                    (t.height = Math.min(
                        Math.max(t.height, t.minHeight),
                        t.maxHeight
                    )),
            ...
            cropStart: function (t) {
                ...
                this.disabled ||
                    ...
                    $.test(a) &&
                        ...
                        (this.cropping = !1),
                        a === O &&
                            ((this.cropping = !0), pt(this.dragBox, m))));
            },
            cropMove: function (t) {
                var e,
                    i = this.action;
                !this.disabled &&
                    ...
                    t.preventDefault(),
                    !1 !==
                        Bt(this.element, M, { originalEvent: t, action: i }) &&
                        (t.changedTouches
                            ? ht(t.changedTouches, function (t) {
            ...
            getCroppedCanvas: function () {
                ...
                var e,
                    ...
                    h =
                        ...
                        (f = void 0 === x || x),
                        (v =
                            void 0 === (m = y.imageSmoothingQuality)
                                ? "low"
                                : m),
                        ...
                        (r = Lt(
                            { aspectRatio: r, width: m, height: i },
                            "cover"
                        )),
                        ...
                        (i = Lt(
                            { aspectRatio: a, width: m, height: i },
                            "cover"
                        )),
